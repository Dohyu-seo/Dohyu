...
public class PageUtil {
	...
	private int pageRow;	// 한 페이지에 보여줄 게시물 갯수
	...
	public void calcPage() {
		/*
		 	총 페이지 수는 총 게시물 수(totalCount)를 한 화면에 표시할 게시물 갯수(pageRow)를
		 	갯수로 나누면 되는데 경우에 따라서는 한 페이지가 증가되어야 하는 경우가 있다.(나머지가 있는경우)
		 */
