...
<link rel="stylesheet" href="/Dohyu/WebContent/css/proj_fixed.css">
<link rel="stylesheet" href="/Dohyu/WebContent/css/modal.css">
<link rel="stylesheet" href="/Dohyu/WebContent/css/w3.css">
<!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-modal/0.9.1/jquery.modal.min.css" /> -->
<script type="text/javascript" src="/Dohyu/WebContent/js/jquery-3.5.0.min.js"></script>
<script type="text/javascript" src="/Dohyu/WebContent/js/fixed.js"></script>
<style> 
 			...
 			/* $('#keyword').keypress(function(e){
				...
				if (keyCode=='13'){
					...
					if(!word){
						...
						document.write("keyCode=13 입력되었습니다.");
					}
				}
			}) */
	...
	<div>
		...
		<div id="header-wrap">
			<div class="header">
				...
				<!-- 검색창 -->
				<div class="searchbox">
					<input id="searchinput" class="searchinput" type="text" placeholder="search" ><!-- onkeypress="if(event.keyCode==13){document.write('이 구역이 Key 입력 13[enter] 후 실행되는 구간입니다.');return false;}" -->
				...
				<div class="iconsbox">
					...
					<div class="span_icons">
						<button type="button" class="butt" id="aBtn">
							<img class="iconimg" id="" src="/Dohyu/WebContent/img/iconmonstr-bell-7-240.png">
						</button>
						<!-- The Modal -->
					...
					<div class="span_icons"> 
						<img class="iconimg" id="" src="/Dohyu/WebContent/img/iconmonstr-compass-4-240.png">
					</div> 
					<div class="span_icons" id=""> 
						<button type="button" class="butt" id="wBtn">
							<img class="iconimg" id="" src="/Dohyu/WebContent/img/iconmonstr-pen-15-240.png">
						</button>
						<!-- The Modal -->
					...
					<div class="span_icons"> 
						<img class="iconimg" id="" src="/Dohyu/WebContent/img/iconmonstr-user-19-240.png">
					</div>
				</div>
			</div>
		</div>
